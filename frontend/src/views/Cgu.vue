  ...
  <div>
    ...
    <v-container class="constrained">
      <v-card-text style="color: #333;">
        ...
        <ul>
          <li>les données obligatoires pour la création du compte : nom, prénom, adresse e-mail. L’équipe chargé du Service est destinataire de ces données,</li>
